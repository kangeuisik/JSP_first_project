...
<script src="${contextPath }/resources/js/adminboard/detail.js">
	...
	<form id="viewForm" enctype="multipart/form-data">
		<table class="table">
			<tr>
				...
				<td>
					${board.abno}
					<input type="hidden" name="abno" value="${board.abno}">
				</td>
				<th>조회수</th>
				<td>0</td>
			</tr>
			...
			<tr>
				...
				<th>파일첨부</th>
					<td colspan="3">
						...
						<div class="preview">
							<img class="originImg" src="${contextPath}/fileDownload?no=${board.bno}&imageFileName=${board.imageFileName}&path=adminboard">
						</div>
					</c:if>
